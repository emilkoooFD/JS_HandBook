...
// Цель: Научиться создавать интерактивную функцию поиска текста среди элементов на странице и выделять найденные элементы.
// Структура:
// Введение
// Суть задания: создать функцию поиска текста среди элементов на странице.
// Что необходимо для реализации: HTML-элементы и поле для ввода текста.
// Подготовка элементов для поиска
// Создание HTML-элементов (div) с текстом или числами.
// Добавление поля для ввода текста (input).
// Программирование функции поиска
// Обработка события ввода в поле (onChange).
// Написание функции search для осуществления поиска.
// Получение значения из поля ввода.
// Поиск среди элементов, содержащих введенный текст.
// Выделение найденных элементов
// Изменение стилей найденных элементов для их выделения.
// Использование класса (например, yellow) для выделения.
...
function search(event) {
    ...
    for (const el of [...root.children]) {
        if(el.innerHTML.includes(inpValue)) {
